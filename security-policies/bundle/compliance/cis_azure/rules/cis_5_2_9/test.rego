...
mismatch_alert_only_category := test_data.generate_activity_log_alert("Microsoft.Network/publicIPAddresses/write", "mismatch_category")

# alert rule that matches the rule
matching_alert := test_data.generate_activity_log_alert("Microsoft.Network/publicIPAddresses/write", "Administrative")
