...
test_violation if {
	...
	eval_fail with input as test_data.generate_azure_asset_with_ext("azure-sql-server", {}, {"sqlVulnerabilityAssessmentSettings": [{"storageAccountName": ""}]})
	eval_fail with input as test_data.generate_azure_asset_with_ext("azure-sql-server", {}, {"sqlVulnerabilityAssessmentSettings": [
		{"storageAccountName": ""},
...
test_pass if {
	eval_pass with input as test_data.generate_azure_asset_with_ext("azure-sql-server", {}, {"sqlVulnerabilityAssessmentSettings": [{"storageAccountName": "sa"}]})
