package compliance.cis_azure.rules.cis_5_2_2
...
mismatch_alert_only_category := test_data.generate_activity_log_alert("Microsoft.Authorization/policyAssignments/delete", "mismatch_category")

# alert rule that matches the rule
matching_alert := test_data.generate_activity_log_alert("Microsoft.Authorization/policyAssignments/delete", "Administrative")
