package compliance.cis_azure.rules.cis_3_14
...
test_fail_all_present if {
	eval_fail with input as test_data.generate_storage_account_with_extensions(
		{},
		{"tableDiagnosticSettings": {"properties": {"logs": [
...
test_fail if {
	...
	eval_fail with input as test_data.generate_storage_account_with_extensions(
		{},
		{"tableDiagnosticSettings": {"properties": {"logs": [{"category": "StorageRead", "enabled": true}]}}},
	)
	...
	eval_fail with input as test_data.generate_storage_account_with_extensions(
		{},
		{"tableDiagnosticSettings": {"properties": {}}},
	)
