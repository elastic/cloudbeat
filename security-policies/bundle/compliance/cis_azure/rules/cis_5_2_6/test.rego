package compliance.cis_azure.rules.cis_5_2_6
...
mismatch_alert_only_category = test_data.generate_activity_log_alert("Microsoft.Security/securitySolutions/delete", "mismatch_category")

# alert rule that matches the rule
matching_alert = test_data.generate_activity_log_alert("Microsoft.Security/securitySolutions/delete", "Administrative")
