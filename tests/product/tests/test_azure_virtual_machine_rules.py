...
from product.tests.data.azure import azure_virtual_machine_test_cases as azure_virtual_machine_tc
...
register_params(
    ...
    Parameters(
        ...
        [*azure_virtual_machine_tc.cis_azure_virtual_machine_cases.values()],
