...
cis_2_2 = [
    (
        "CIS 2.2",
        {"unset": ["--client-cert-auth"]},
        "/etc/kubernetes/manifests/etcd.yaml",
        "failed",
    ),
    (
        "CIS 2.2",
        {"set": {"--client-cert-auth": "false"}},
        "/etc/kubernetes/manifests/etcd.yaml",
        "failed",
    ),
    (
...
cis_2_5 = [
    (
        "CIS 2.5",
        {"unset": ["--peer-client-cert-auth"]},
        "/etc/kubernetes/manifests/etcd.yaml",
        "failed",
    ),
    (
        "CIS 2.5",
        {"set": {"--peer-client-cert-auth": "false"}},
        "/etc/kubernetes/manifests/etcd.yaml",
        "failed",
    ),
    (
...
cis_2_6 = [
    (
        "CIS 2.6",
        {"set": {"--peer-auto-tls": "false"}},
        "/etc/kubernetes/manifests/etcd.yaml",
        "passed",
    ),
    (
        "CIS 2.6",
        {"set": {"--peer-auto-tls": "true"}},
        "/etc/kubernetes/manifests/etcd.yaml",
        "failed",
    ),
    (
...
cis_1_3_3 = [
    ...
    (
        "CIS 1.3.3",
        {"set": {"--use-service-account-credentials": "true"}},
        "/etc/kubernetes/manifests/kube-controller-manager.yaml",
        "passed",
    ),
]
...
cis_1_3_6 = [
    (
        "CIS 1.3.6",
        {"set": {"--feature-gates": "RotateKubeletServerCertificate=false"}},
        "/etc/kubernetes/manifests/kube-controller-manager.yaml",
        "failed",
    ),
    (
...
cis_1_2_10 = [
    (
        "CIS 1.2.10",
        {"unset": ["--enable-admission-plugins"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
...
cis_1_2_11 = [
    (
        "CIS 1.2.11",
        {"set": {"--enable-admission-plugins": "AlwaysAdmit"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
...
cis_1_2_12 = [
    ...
    (
        "CIS 1.2.12",
        {"set": {"--enable-admission-plugins": "AlwaysPullImages"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
]
...
cis_1_2_13 = [
    ...
    (
        "CIS 1.2.13",
        {"set": {"--enable-admission-plugins": "SecurityContextDeny"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.13",
        {"set": {"--enable-admission-plugins": "PodSecurityPolicy"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
]
...
cis_1_2_14 = [
    (
        "CIS 1.2.14",
        {"set": {"--disable-admission-plugins": "ServiceAccount"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
        "CIS 1.2.14",
        {"unset": ["--disable-admission-plugins"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
]
...
cis_1_2_15 = [
    (
        "CIS 1.2.15",
        {"set": {"--disable-admission-plugins": "NamespaceLifecycle"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
...
cis_1_2_20 = [
    (
        "CIS 1.2.20",
        {"set": {"--audit-log-maxage": "260492"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.20",
        {"set": {"--audit-log-maxage": "30"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.20",
        {"unset": ["--audit-log-maxage"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
]
...
cis_1_2_21 = [
    (
        "CIS 1.2.21",
        {"set": {"--audit-log-maxbackup": "-1"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
        "CIS 1.2.21",
        {"set": {"--audit-log-maxbackup": "10"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.21",
        {"unset": ["--audit-log-maxbackup"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
]
...
cis_1_2_22 = [
    (
        "CIS 1.2.22",
        {"set": {"--audit-log-maxsize": "-1"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
        "CIS 1.2.22",
        {"set": {"--audit-log-maxsize": "100"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.22",
        {"unset": ["--audit-log-maxsize"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
]
...
cis_1_2_23 = [
    (
        "CIS 1.2.23",
        {"set": {"--request-timeout": "59s"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
        "CIS 1.2.23",
        {"set": {"--request-timeout": "300s"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.23",
        {"unset": ["--request-timeout"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
]
...
cis_1_2_24 = [
    (
        "CIS 1.2.24",
        {"set": {"--service-account-lookup": "false"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "failed",
    ),
    (
        "CIS 1.2.24",
        {"set": {"--service-account-lookup": "true"}},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
    (
        "CIS 1.2.24",
        {"unset": ["--service-account-lookup"]},
        "/etc/kubernetes/manifests/kube-apiserver.yaml",
        "passed",
    ),
]
...
cis_4_2_1 = [
    (
        "CIS 4.2.1",
        {
            "set": {"authentication": {"anonymous": {"enabled": True}}},
        },
...
cis_4_2_5 = [
    (
        "CIS 4.2.5",
        {"set": {"streamingConnectionIdleTimeout": 0}},
        "/var/lib/kubelet/config.yaml",
        "failed",
    ),
    (
        "CIS 4.2.5",
        {"set": {"streamingConnectionIdleTimeout": "26492s"}},
        "/var/lib/kubelet/config.yaml",
        "passed",
    ),
]
...
cis_4_2_6 = [
    (
        "CIS 4.2.6",
        {"set": {"protectKernelDefaults": False}},
        "/var/lib/kubelet/config.yaml",
        "failed",
    ),
    (
        "CIS 4.2.6",
        {"set": {"protectKernelDefaults": True}},
        "/var/lib/kubelet/config.yaml",
        "passed",
    ),
]
...
cis_4_2_7 = [
    (
        "CIS 4.2.7",
        {"set": {"makeIPTablesUtilChains": False}},
        "/var/lib/kubelet/config.yaml",
        "failed",
    ),
    (
        "CIS 4.2.7",
        {"set": {"makeIPTablesUtilChains": True}},
        "/var/lib/kubelet/config.yaml",
        "passed",
    ),
]
...
cis_4_2_9 = [
    (
        "CIS 4.2.9",
        {"set": {"eventRecordQPS": 4}},
        "/var/lib/kubelet/config.yaml",
        "failed",
    ),
    (
        "CIS 4.2.9",
        {"set": {"eventRecordQPS": 0}},
        "/var/lib/kubelet/config.yaml",
        "passed",
    ),
]
...
cis_4_2_11 = [
    (
        "CIS 4.2.11",
        {"set": {"rotateCertificates": False}},
        "/var/lib/kubelet/config.yaml",
        "failed",
    ),
    (
        "CIS 4.2.11",
        {"set": {"rotateCertificates": True}},
        "/var/lib/kubelet/config.yaml",
        "passed",
    ),
]
...
cis_4_2_13 = [
    (
        "CIS 4.2.13",
        {"set": {"TLSCipherSuites": ["TLS_ECDHE_ECDSA_WITH_AES_128_GCM_DUMMY"]}},
        "/var/lib/kubelet/config.yaml",
        "failed",
    ),
    (
        "CIS 4.2.13",
        {"set": {"TLSCipherSuites": ["TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256"]}},
        "/var/lib/kubelet/config.yaml",
        "passed",
    ),
    (
