...
def test_eks_kube_objects(elastic_client,
                          cloudbeat_agent,
                          rule_tag,
                          test_resource_id,
                          expected):
...
register_params(test_eks_kube_objects, Parameters(
    ...
    [
        ...
        *eks_k8s_object_tc.cis_eks_4_2_7.values(),
        # *eks_k8s_object_tc.cis_eks_4_2_8.values(), # TODO to check if finding retrieved on real env
