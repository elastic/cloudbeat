"""
CIS Azure Microsoft Defender rules verification.
...
from product.tests.data.azure import azure_microsoft_defender_test_cases as azure_microsoft_defender_tc
from product.tests.parameters import register_params, Parameters
from .data.constants import RES_NAME


@pytest.mark.azure_microsoft_defender_rules
def test_azure_microsoft_defender_rules(
    cspm_client,
    cloudbeat_agent,
    rule_tag,
    case_identifier,
    ...
    """
    defender_identifier = partial(res_identifier, RES_NAME, case_identifier)
    ...
    evaluation = get_ES_evaluation(
        ...
        resource_identifier=defender_identifier,
    )
...
register_params(
    test_azure_microsoft_defender_rules,
    Parameters(
        ("rule_tag", "case_identifier", "expected"),
        [*azure_microsoft_defender_tc.test_cases.values()],
        ids=[*azure_microsoft_defender_tc.test_cases.keys()],
    ),
)
