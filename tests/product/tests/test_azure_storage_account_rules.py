...
from product.tests.data.azure import azure_storage_account_test_cases as azure_storage_account_tc
from product.tests.parameters import register_params, Parameters
from .data.constants import RES_NAME


@pytest.mark.azure_storage_account_rules
def test_azure_storage_account_rules(
    cspm_client,
    cloudbeat_agent,
    rule_tag,
    case_identifier,
    ...
    """
    storage_account_identifier = partial(res_identifier, RES_NAME, case_identifier)
    ...
    evaluation = get_ES_evaluation(
        ...
        resource_identifier=storage_account_identifier,
    )
