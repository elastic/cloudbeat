"""
CIS Azure Networking rules verification.
...
from product.tests.data.azure import azure_networking_test_cases as azure_networking_tc
...
def test_azure_networking_rules(
    ...
    """
    networking_identifier = partial(res_identifier, RES_NAME, case_identifier)
    ...
    evaluation = get_ES_evaluation(
        ...
        resource_identifier=networking_identifier,
    )
