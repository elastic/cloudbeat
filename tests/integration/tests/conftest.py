...
@pytest.fixture(scope='module', name='start_stop')
def fixture_start_stop(k8s, api_client, cloudbeat_agent):
    """
...
def fixture_data(start_stop, k8s, cloudbeat_agent):
    """
    This fixture is used for preparing data for integration test
    @param start_stop: fixture to start and stop agent / cloudbeat
