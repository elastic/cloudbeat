...
test_violation {
	...
	test.assert_fail(finding) with input as rule_input("controller_manager", "--bind-address=127.0.0.2")
}

test_pass {
	test.assert_pass(finding) with input as rule_input("controller_manager", "--bind-address=127.0.0.1")
}
