...
test_violation {
	test.assert_violation(finding) with input as rule_input("kube-apiserver.yaml", "root", "user")
	test.assert_violation(finding) with input as rule_input("kube-apiserver.yaml", "user", "root")
	test.assert_violation(finding) with input as rule_input("kube-apiserver.yaml", "user", "user")
}
