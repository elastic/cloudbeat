...
// ClusterId provides a mock function for the type MockClusterHelper
func (_mock *MockClusterHelper) ClusterId() string {
	ret := _mock.Called()
...
func (_c *MockClusterHelper_ClusterId_Call) Return(s string) *MockClusterHelper_ClusterId_Call {
	_c.Call.Return(s)
	return _c
}
