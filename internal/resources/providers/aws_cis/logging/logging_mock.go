...
func (_mock *MockClient) DescribeTrails(ctx context.Context) ([]awslib.AwsResource, error) {
...
func (_c *MockClient_DescribeTrails_Call) Return(awsResources []awslib.AwsResource, err error) *MockClient_DescribeTrails_Call {
	_c.Call.Return(awsResources, err)
	return _c
}

func (_c *MockClient_DescribeTrails_Call) RunAndReturn(run func(ctx context.Context) ([]awslib.AwsResource, error)) *MockClient_DescribeTrails_Call {
	_c.Call.Return(run)
	return _c
}
