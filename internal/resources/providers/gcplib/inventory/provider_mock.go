...
func (_mock *MockProviderInitializerAPI) Init(ctx context.Context, log *clog.Logger, gcpConfig auth.GcpFactoryConfig) (ServiceAPI, error) {
	ret := _mock.Called(ctx, log, gcpConfig)
	...
	var r0 ServiceAPI
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *clog.Logger, auth.GcpFactoryConfig) (ServiceAPI, error)); ok {
		return returnFunc(ctx, log, gcpConfig)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *clog.Logger, auth.GcpFactoryConfig) ServiceAPI); ok {
		r0 = returnFunc(ctx, log, gcpConfig)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ServiceAPI)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, *clog.Logger, auth.GcpFactoryConfig) error); ok {
		r1 = returnFunc(ctx, log, gcpConfig)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockProviderInitializerAPI_Init_Call) RunAndReturn(run func(ctx context.Context, log *clog.Logger, gcpConfig auth.GcpFactoryConfig) (ServiceAPI, error)) *MockProviderInitializerAPI_Init_Call {
	_c.Call.Return(run)
	return _c
}
