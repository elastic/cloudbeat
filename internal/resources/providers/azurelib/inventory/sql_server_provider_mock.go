...
// GetSQLBlobAuditingPolicies provides a mock function for the type MockSQLProviderAPI
func (_mock *MockSQLProviderAPI) GetSQLBlobAuditingPolicies(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error) {
...
func (_c *MockSQLProviderAPI_GetSQLBlobAuditingPolicies_Call) Return(azureAssets []AzureAsset, err error) *MockSQLProviderAPI_GetSQLBlobAuditingPolicies_Call {
	_c.Call.Return(azureAssets, err)
	return _c
}

func (_c *MockSQLProviderAPI_GetSQLBlobAuditingPolicies_Call) RunAndReturn(run func(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error)) *MockSQLProviderAPI_GetSQLBlobAuditingPolicies_Call {
	_c.Call.Return(run)
	return _c
}

// ListSQLAdvancedThreatProtectionSettings provides a mock function for the type MockSQLProviderAPI
func (_mock *MockSQLProviderAPI) ListSQLAdvancedThreatProtectionSettings(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error) {
	ret := _mock.Called(ctx, subID, resourceGroup, serverName)
...
func (_c *MockSQLProviderAPI_ListSQLAdvancedThreatProtectionSettings_Call) Return(azureAssets []AzureAsset, err error) *MockSQLProviderAPI_ListSQLAdvancedThreatProtectionSettings_Call {
	_c.Call.Return(azureAssets, err)
	return _c
}

func (_c *MockSQLProviderAPI_ListSQLAdvancedThreatProtectionSettings_Call) RunAndReturn(run func(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error)) *MockSQLProviderAPI_ListSQLAdvancedThreatProtectionSettings_Call {
	_c.Call.Return(run)
	return _c
}

// ListSQLEncryptionProtector provides a mock function for the type MockSQLProviderAPI
func (_mock *MockSQLProviderAPI) ListSQLEncryptionProtector(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error) {
	ret := _mock.Called(ctx, subID, resourceGroup, serverName)
...
func (_c *MockSQLProviderAPI_ListSQLEncryptionProtector_Call) Return(azureAssets []AzureAsset, err error) *MockSQLProviderAPI_ListSQLEncryptionProtector_Call {
	_c.Call.Return(azureAssets, err)
	return _c
}

func (_c *MockSQLProviderAPI_ListSQLEncryptionProtector_Call) RunAndReturn(run func(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error)) *MockSQLProviderAPI_ListSQLEncryptionProtector_Call {
	_c.Call.Return(run)
	return _c
}

// ListSQLFirewallRules provides a mock function for the type MockSQLProviderAPI
func (_mock *MockSQLProviderAPI) ListSQLFirewallRules(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error) {
	ret := _mock.Called(ctx, subID, resourceGroup, serverName)
...
func (_c *MockSQLProviderAPI_ListSQLFirewallRules_Call) Return(azureAssets []AzureAsset, err error) *MockSQLProviderAPI_ListSQLFirewallRules_Call {
	_c.Call.Return(azureAssets, err)
	return _c
}

func (_c *MockSQLProviderAPI_ListSQLFirewallRules_Call) RunAndReturn(run func(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error)) *MockSQLProviderAPI_ListSQLFirewallRules_Call {
	_c.Call.Return(run)
	return _c
}

// ListSQLTransparentDataEncryptions provides a mock function for the type MockSQLProviderAPI
func (_mock *MockSQLProviderAPI) ListSQLTransparentDataEncryptions(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error) {
	ret := _mock.Called(ctx, subID, resourceGroup, serverName)
...
func (_c *MockSQLProviderAPI_ListSQLTransparentDataEncryptions_Call) Return(azureAssets []AzureAsset, err error) *MockSQLProviderAPI_ListSQLTransparentDataEncryptions_Call {
	_c.Call.Return(azureAssets, err)
	return _c
}

func (_c *MockSQLProviderAPI_ListSQLTransparentDataEncryptions_Call) RunAndReturn(run func(ctx context.Context, subID string, resourceGroup string, serverName string) ([]AzureAsset, error)) *MockSQLProviderAPI_ListSQLTransparentDataEncryptions_Call {
	_c.Call.Return(run)
	return _c
}
