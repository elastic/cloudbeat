...
// GetCallerIdentity provides a mock function with given fields: ctx, cfg
func (_m *MockIdentityProviderGetter) GetCallerIdentity(ctx context.Context, cfg aws.Config) (sts.GetCallerIdentityOutput, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, aws.Config) (sts.GetCallerIdentityOutput, error)); ok {
		return rf(ctx, cfg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, aws.Config) sts.GetCallerIdentityOutput); ok {
		r0 = rf(ctx, cfg)
	} else {
...
func (_c *MockIdentityProviderGetter_GetCallerIdentity_Call) Return(_a0 sts.GetCallerIdentityOutput, _a1 error) *MockIdentityProviderGetter_GetCallerIdentity_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIdentityProviderGetter_GetCallerIdentity_Call) RunAndReturn(run func(context.Context, aws.Config) (sts.GetCallerIdentityOutput, error)) *MockIdentityProviderGetter_GetCallerIdentity_Call {
	_c.Call.Return(run)
	return _c
}
