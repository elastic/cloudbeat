...
// DescribeMetricFilters provides a mock function for the type MockCloudwatchLogs
func (_mock *MockCloudwatchLogs) DescribeMetricFilters(ctx context.Context, region *string, logGroup string) ([]types.MetricFilter, error) {
	ret := _mock.Called(ctx, region, logGroup)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *string, string) ([]types.MetricFilter, error)); ok {
		return returnFunc(ctx, region, logGroup)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *string, string) []types.MetricFilter); ok {
		r0 = returnFunc(ctx, region, logGroup)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *string, string) error); ok {
		r1 = returnFunc(ctx, region, logGroup)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockCloudwatchLogs_DescribeMetricFilters_Call) Return(metricFilters []types.MetricFilter, err error) *MockCloudwatchLogs_DescribeMetricFilters_Call {
	_c.Call.Return(metricFilters, err)
	return _c
}

func (_c *MockCloudwatchLogs_DescribeMetricFilters_Call) RunAndReturn(run func(ctx context.Context, region *string, logGroup string) ([]types.MetricFilter, error)) *MockCloudwatchLogs_DescribeMetricFilters_Call {
	_c.Call.Return(run)
	return _c
}
