...
// Degraded provides a mock function with given fields: message
func (_m *MockStatusHandlerAPI) Degraded(message string) {
	_m.Called(message)
}
...
func (_c *MockStatusHandlerAPI_Degraded_Call) RunAndReturn(run func(string)) *MockStatusHandlerAPI_Degraded_Call {
	_c.Run(run)
	return _c
}

// Reset provides a mock function with no fields
func (_m *MockStatusHandlerAPI) Reset() {
	_m.Called()
}
