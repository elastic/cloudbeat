...
func (_m *mockInstancesProvider) DescribeInstances(ctx context.Context) ([]*ec2.Ec2Instance, error) {
	ret := _m.Called(ctx)
...
func (_c *mockInstancesProvider_DescribeInstances_Call) Return(_a0 []*ec2.Ec2Instance, _a1 error) *mockInstancesProvider_DescribeInstances_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockInstancesProvider_DescribeInstances_Call) RunAndReturn(run func(context.Context) ([]*ec2.Ec2Instance, error)) *mockInstancesProvider_DescribeInstances_Call {
	_c.Call.Return(run)
	return _c
}
