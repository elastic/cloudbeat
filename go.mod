...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20240906002333-88dfb9e661f9
...
require (
	...
	github.com/elastic/elastic-agent-system-metrics v0.10.4-0.20240826151019-9db0a02d3b85 // indirect
