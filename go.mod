...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/keyvault/armkeyvault v2.0.1
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20260119133310-d0d6640fc36a // indirect
