...
type mockConstructorTestingTNewMockElasticCommonDataProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockElasticCommonDataProvider(t mockConstructorTestingTNewMockElasticCommonDataProvider) *MockElasticCommonDataProvider {
