...
type mockConstructorTestingTNewMockClientGetterAPI interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockClientGetterAPI(t mockConstructorTestingTNewMockClientGetterAPI) *MockClientGetterAPI {
