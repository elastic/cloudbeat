...
func (_m *MockOption) Execute(_a0 *FileSystemFetcher) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *FileSystemFetcher)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*FileSystemFetcher))
	})
	return _c
}
