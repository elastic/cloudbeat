...
func (_m *MockOption) Execute(_a0 *LoggingFetcher) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *LoggingFetcher)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*LoggingFetcher))
	})
	return _c
}
