...
func (_c *MockKubernetesClientGetter_GetClient_Call) RunAndReturn(run func(*logp.Logger, string, kubernetes.KubeClientOptions) (client_gokubernetes.Interface, error)) *MockKubernetesClientGetter_GetClient_Call {
	_c.Call.Return(run)
	return _c
}
