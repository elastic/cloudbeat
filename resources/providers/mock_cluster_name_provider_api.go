...
func (_m *MockClusterNameProviderAPI) GetClusterName(ctx context.Context, cfg *config.Config, log *logp.Logger) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *config.Config, *logp.Logger) (string, error)); ok {
...
func (_c *MockClusterNameProviderAPI_GetClusterName_Call) RunAndReturn(run func(context.Context, *config.Config, *logp.Logger) (string, error)) *MockClusterNameProviderAPI_GetClusterName_Call {
	_c.Call.Return(run)
	return _c
}
