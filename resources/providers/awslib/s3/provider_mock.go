...
func (_m *MockS3) GetBucketACL(ctx context.Context, bucketName *string, region string) ([]types.Grant, error) {
	ret := _m.Called(ctx, bucketName, region)

	var r0 []types.Grant
	if rf, ok := ret.Get(0).(func(context.Context, *string, string) []types.Grant); ok {
		r0 = rf(ctx, bucketName, region)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]types.Grant)
		}
	}
...
func (_c *MockS3_GetBucketACL_Call) Return(_a0 []types.Grant, _a1 error) *MockS3_GetBucketACL_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
