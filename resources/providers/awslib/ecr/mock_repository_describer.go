...
type mockConstructorTestingTNewMockRepositoryDescriber interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRepositoryDescriber(t mockConstructorTestingTNewMockRepositoryDescriber) *MockRepositoryDescriber {
