...
func (_m *MockConfigGetter) InitializeAWSConfig(ctx context.Context, cfg aws.ConfigAWS) (aws_sdk_go_v2aws.Config, error) {
...
// MockConfigGetter_InitializeAWSConfig_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InitializeAWSConfig'
type MockConfigGetter_InitializeAWSConfig_Call struct {
	*mock.Call
}
...
//  - ctx context.Context
//  - cfg aws.ConfigAWS
func (_e *MockConfigGetter_Expecter) InitializeAWSConfig(ctx interface{}, cfg interface{}) *MockConfigGetter_InitializeAWSConfig_Call {
	return &MockConfigGetter_InitializeAWSConfig_Call{Call: _e.mock.On("InitializeAWSConfig", ctx, cfg)}
}

func (_c *MockConfigGetter_InitializeAWSConfig_Call) Run(run func(ctx context.Context, cfg aws.ConfigAWS)) *MockConfigGetter_InitializeAWSConfig_Call {
...
func (_c *MockConfigGetter_InitializeAWSConfig_Call) Return(_a0 aws_sdk_go_v2aws.Config, _a1 error) *MockConfigGetter_InitializeAWSConfig_Call {
