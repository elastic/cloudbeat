...
func (_m *MockEksClusterDescriber) DescribeCluster(ctx context.Context, clusterName string) (EksClusterOutput, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (EksClusterOutput, error)); ok {
...
func (_c *MockEksClusterDescriber_DescribeCluster_Call) RunAndReturn(run func(context.Context, string) (EksClusterOutput, error)) *MockEksClusterDescriber_DescribeCluster_Call {
	_c.Call.Return(run)
	return _c
}
