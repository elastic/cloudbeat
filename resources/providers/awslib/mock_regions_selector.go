...
type mockConstructorTestingTNewMockRegionsSelector interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRegionsSelector(t mockConstructorTestingTNewMockRegionsSelector) *MockRegionsSelector {
