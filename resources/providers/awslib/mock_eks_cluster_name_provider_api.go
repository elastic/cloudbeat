...
type mockConstructorTestingTNewMockEKSClusterNameProviderAPI interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockEKSClusterNameProviderAPI(t mockConstructorTestingTNewMockEKSClusterNameProviderAPI) *MockEKSClusterNameProviderAPI {
