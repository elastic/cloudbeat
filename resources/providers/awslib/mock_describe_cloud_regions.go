...
type mockConstructorTestingTnewMockDescribeCloudRegions interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDescribeCloudRegions(t mockConstructorTestingTnewMockDescribeCloudRegions) *mockDescribeCloudRegions {
