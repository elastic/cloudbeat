...
func (_m *MockEcrRepositoryDescriber) DescribeRepositories(ctx context.Context, cfg aws.Config, repoNames []string, region string) (EcrRepositories, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, aws.Config, []string, string) (EcrRepositories, error)); ok {
		return rf(ctx, cfg, repoNames, region)
	}
...
func (_c *MockEcrRepositoryDescriber_DescribeRepositories_Call) RunAndReturn(run func(context.Context, aws.Config, []string, string) (EcrRepositories, error)) *MockEcrRepositoryDescriber_DescribeRepositories_Call {
	_c.Call.Return(run)
	return _c
}
