...
// MockClusterNameProvider is an autogenerated mock type for the EKSClusterNameProviderAPI type
...
func (_c *MockClusterNameProvider_GetClusterName_Call) RunAndReturn(run func(context.Context, aws.Config, string) (string, error)) *MockClusterNameProvider_GetClusterName_Call {
	_c.Call.Return(run)
	return _c
}
