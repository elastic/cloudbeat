...
func (_m *MockMetadataProvider) GetMetadata(ctx context.Context, cfg aws.Config) (ec2imds.InstanceIdentityDocument, error) {
	ret := _m.Called(ctx, cfg)

	var r0 ec2imds.InstanceIdentityDocument
	if rf, ok := ret.Get(0).(func(context.Context, aws.Config) ec2imds.InstanceIdentityDocument); ok {
		r0 = rf(ctx, cfg)
	} else {
		r0 = ret.Get(0).(ec2imds.InstanceIdentityDocument)
	}
...
func (_c *MockMetadataProvider_GetMetadata_Call) Return(_a0 ec2imds.InstanceIdentityDocument, _a1 error) *MockMetadataProvider_GetMetadata_Call {
