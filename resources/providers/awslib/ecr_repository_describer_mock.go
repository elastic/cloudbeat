...
func (_m *MockEcrRepositoryDescriber) DescribeRepositories(ctx context.Context, cfg aws.Config, repoNames []string, region string) (ECRProviderResponse, error) {
	ret := _m.Called(ctx, cfg, repoNames, region)

	var r0 ECRProviderResponse
	if rf, ok := ret.Get(0).(func(context.Context, aws.Config, []string, string) ECRProviderResponse); ok {
		r0 = rf(ctx, cfg, repoNames, region)
	} else {
		r0 = ret.Get(0).(ECRProviderResponse)
	}
...
func (_c *MockEcrRepositoryDescriber_DescribeRepositories_Call) Return(_a0 ECRProviderResponse, _a1 error) *MockEcrRepositoryDescriber_DescribeRepositories_Call {
