...
type mockConstructorTestingTNewMockGoogleAuthProviderAPI interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockGoogleAuthProviderAPI(t mockConstructorTestingTNewMockGoogleAuthProviderAPI) *MockGoogleAuthProviderAPI {
