...
func (_m *MockServiceAPI) ListAllAssetTypesByName(assets []string) ([]*assetpb.Asset, error) {
...
func (_c *MockServiceAPI_ListAllAssetTypesByName_Call) Return(_a0 []*assetpb.Asset, _a1 error) *MockServiceAPI_ListAllAssetTypesByName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServiceAPI_ListAllAssetTypesByName_Call) RunAndReturn(run func([]string) ([]*assetpb.Asset, error)) *MockServiceAPI_ListAllAssetTypesByName_Call {
	_c.Call.Return(run)
	return _c
}
