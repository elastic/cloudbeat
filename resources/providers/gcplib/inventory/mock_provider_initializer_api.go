...
type mockConstructorTestingTNewMockProviderInitializerAPI interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockProviderInitializerAPI(t mockConstructorTestingTNewMockProviderInitializerAPI) *MockProviderInitializerAPI {
