...
func (_m *MockProviderAPI) ListSQLVulnerabilityAssessmentSettings(ctx context.Context, subID string, resourceGroup string, serverName string) ([]inventory.AzureAsset, error) {
	ret := _m.Called(ctx, subID, resourceGroup, serverName)
...
// MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListSQLVulnerabilityAssessmentSettings'
type MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call struct {
	*mock.Call
}
...
//   - resourceGroup string
//   - serverName string
func (_e *MockProviderAPI_Expecter) ListSQLVulnerabilityAssessmentSettings(ctx interface{}, subID interface{}, resourceGroup interface{}, serverName interface{}) *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call {
	return &MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call{Call: _e.mock.On("ListSQLVulnerabilityAssessmentSettings", ctx, subID, resourceGroup, serverName)}
}

func (_c *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call) Run(run func(ctx context.Context, subID string, resourceGroup string, serverName string)) *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(string))
	})
	return _c
...
func (_c *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call) Return(_a0 []inventory.AzureAsset, _a1 error) *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call) RunAndReturn(run func(context.Context, string, string, string) ([]inventory.AzureAsset, error)) *MockProviderAPI_ListSQLVulnerabilityAssessmentSettings_Call {
	_c.Call.Return(run)
	return _c
}
