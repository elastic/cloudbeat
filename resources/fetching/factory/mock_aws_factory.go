...
func (_c *mockAwsFactory_Execute_Call) Return(_a0 FetchersMap) *mockAwsFactory_Execute_Call {
	_c.Call.Return(_a0)
	return _c
}
...
type mockConstructorTestingTnewMockAwsFactory interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockAwsFactory(t mockConstructorTestingTnewMockAwsFactory) *mockAwsFactory {
	mock := &mockAwsFactory{}
	mock.Mock.Test(t)
