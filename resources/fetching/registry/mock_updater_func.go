...
import (
	factory "github.com/elastic/cloudbeat/resources/fetching/factory"
...
func (_m *MockUpdaterFunc) Execute() (factory.FetchersMap, error) {
	ret := _m.Called()

	var r0 factory.FetchersMap
	var r1 error
	if rf, ok := ret.Get(0).(func() (factory.FetchersMap, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() factory.FetchersMap); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(factory.FetchersMap)
		}
	}
...
func (_c *MockUpdaterFunc_Execute_Call) Return(_a0 factory.FetchersMap, _a1 error) *MockUpdaterFunc_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUpdaterFunc_Execute_Call) RunAndReturn(run func() (factory.FetchersMap, error)) *MockUpdaterFunc_Execute_Call {
	_c.Call.Return(run)
	return _c
}

type mockConstructorTestingTNewMockUpdaterFunc interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockUpdaterFunc(t mockConstructorTestingTNewMockUpdaterFunc) *MockUpdaterFunc {
