...
func (_m *MockOSUser) GetGroupNameFromID(gid uint32, groupFilePath string) (string, error) {
	ret := _m.Called(gid, groupFilePath)

	var r0 string
	if rf, ok := ret.Get(0).(func(uint32, string) string); ok {
...
func (_c *MockOSUser_GetGroupNameFromID_Call) Run(run func(gid uint32, groupFilePath string)) *MockOSUser_GetGroupNameFromID_Call {
...
func (_m *MockOSUser) GetUserNameFromID(uid uint32, userFilePath string) (string, error) {
...
func (_c *MockOSUser_GetUserNameFromID_Call) Run(run func(uid uint32, userFilePath string)) *MockOSUser_GetUserNameFromID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint32), args[1].(string))
	})
	return _c
