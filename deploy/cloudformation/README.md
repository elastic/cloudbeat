...
```
STACK_NAME="<Unique stack name>" # e.g.: john-qa-bc2-8-9-0-May28 or developeraccess-orestis-stack
...
Note: to enable SSH access to the EC2 instance, your `STACK_NAME` must start with `developeraccess-`.
